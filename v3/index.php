...
<body>
    ...
    switch($action) {
        ...
        case "mostrarFormularioLogin";
            $vista->mostrar("usuario/formularioLogin");
        break;
        ...
        case "procesarLogin":
            ...
            $result = $usuario->buscarUsuario($user, $passwd);

            if ($result) {
                echo "<script>location.href = 'index.php'</script>";
            } else {
                $data['msjError'] = "Nombre de usuario o contraseña incorrectos";
				$vista->mostrar("usuario/formularioLogin", $data);
            }
        ...
        case 'cerrarSesion':
            session_destroy();
            $data['msjInfo'] = "Sesión cerrada con éxito";
			$vista->mostrar("usuario/formularioLogin", $data);
        break;


        case "mostrarListaLibros":
            $data['listaLibros'] = $libro->getAll();
            $vista->mostrar("libro/mostrarListaLibros", $data);
        break;
